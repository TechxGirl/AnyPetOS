...
function AuthenticatedApp({ profile }) {
  ...
  const saving = {
    edit: activePetId ? isPending(`edit-pet-${activePetId}`) : false,
    delete: activePetId ? isPending(`delete-pet-${activePetId}`) : false,
    feed: activePetId ? isPending(`feed-${activePetId}`) : false,
    weight: activePetId ? isPending(`weight-${activePetId}`) : false,
    shed: activePetId ? isPending(`shed-${activePetId}`) : false,
  ...
  return (
    <AppLayout
      sidebar={
        <Sidebar page={page} setPage={navigateToPage} user={currentUser} />
      }
    >
      <PageRenderer
        page={page}
