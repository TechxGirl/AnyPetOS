...
export const USER_ROLES = [
  ...
  },
  {
    ...
    icon: "🧬",
    description:
      "Manage animals, collections, breeding records, sales, and expo tools.",
    features: [
  ...
  },
  {
    ...
    icon: "🦎",
    description:
      "Track intakes, rehab, quarantine, medical history, and adoptions.",
    features: [
  ...
  },
  {
    ...
    icon: "🩺",
    description:
      "Review medical history, medications, weights, and care timelines.",
    features: [
  ...
  },
  {
    ...
    icon: "🐶",
    description:
      "View care instructions, feeding, medications, and emergency notes.",
    features: [
  ...
  },
  {
    ...
    icon: "🏫",
    description:
      "Manage ambassador animals, care records, and educational collections.",
    features: [
