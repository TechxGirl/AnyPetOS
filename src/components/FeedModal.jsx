...
export default function FeedModal({ pet, close, feedPet, saving = false }) {
  ...
  const isInsectPlan =
    feedingPlan.type === "insectivore" || feedingPlan.type === "omnivore";
      ...
      >
        <div className="profileHeader smartFeedHeader">
          <div>
            ...
            <p>
              {pet.name} • {pet.species || "Species not set"}
            </p>
          </div>
        ...
        <div className="smartFeedGrid">
          <div className="card innerCard smartFeedPanel">
            <div className="smartFeedPanelHeader">
              ...
              <span className="smartFeedTypePill">
                {feedingPlan.type}
              </span>
            </div>
            ...
            {customFood.trim() && (
              <label className="checkboxLine smartFeedCheck">
                <input
                  ...
                  onChange={(event) =>
                    setSaveCustomFood(event.target.checked)
                  }
                />
              ...
              <div className="smartMealList">
                ...
                {mealItems.map((item) => (
                  ...
                  >
                    ...
                    <small>
                      {item.custom ? "Custom" : "Saved"} • click to remove
                    </small>
                  </button>
                ))}
              </div>
            ...
            {feedingPlan.showPreyReminder && (
              <p className="smartFeedHint">
                Prey sizing note: use the size dropdown to record what was
                offered. Adjust prey choice for the animal's age, body
                condition, and safe husbandry guidance.
              </p>
            )}
          </div>
          ...
          <div className="card innerCard smartFeedPanel">
            <div className="smartFeedPanelHeader">
              <div>
                ...
                <p>
                  Track response, refusals, dusting, and weight context.
                </p>
              </div>
            </div>
              ...
              <div className="smartFeedChecks">
                <label className="checkboxLine smartFeedCheck">
                  <input
                    ...
                    checked={gutLoaded}
                    onChange={(event) =>
                      setGutLoaded(event.target.checked)
                    }
                  />
                ...
                <label className="checkboxLine smartFeedCheck">
                  <input
                    type="checkbox"
                    checked={calciumDusted}
                    onChange={(event) =>
                      setCalciumDusted(event.target.checked)
                    }
                  />
                ...
                <label className="checkboxLine smartFeedCheck">
                  <input
                    type="checkbox"
                    checked={vitaminDusted}
                    onChange={(event) =>
                      setVitaminDusted(event.target.checked)
                    }
                  />
